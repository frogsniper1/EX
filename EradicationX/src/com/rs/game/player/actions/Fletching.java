...
public class Fletching extends Action {
	...
	// fixed by dragonkk as always // well dragonkk did a shit job
	...
	public static boolean maxMakeQuantityTen2(Fletch fletch, int id) {
		return fletch.getProduct()[id] == 52
				|| fletch.getSelected() == 52
				|| fletch.getSelected() == 53
				|| fletch.getSelected() == 314
				|| ItemDefinitions.getItemDefinitions(fletch.getSelected())
	...
	public int processWithDelay(Player player) {
		ticks--;
		int amount = maxMakeQuantityTen2(fletch, option) ? 15 : 1;
		if (fletch.getId() != 52 || fletch.getId() != 53 || fletch.getId() != 314 || fletch.getId() != 52)
