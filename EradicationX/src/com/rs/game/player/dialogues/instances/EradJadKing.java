...
public class EradJadKing extends Dialogue {
	

	public void setPerma(boolean bool) {
		player.setPermaEradJad(bool);
	}
	private String getString = "EradJadInstance";
	public void startControler() {
		player.getControlerManager().startControler("EradJadInstance");	
	}
	public EradJadKing() {
	}
	...
	public void run(int interfaceId, int componentId) {
		boolean getPerma = player.isPermaEradJad();
		if (stage == 1) {	
			if (componentId == OPTION_1) {
				Magic.sendNormalTeleportSpell(player, 0, 0, new WorldTile(2146, 5538, 3));
