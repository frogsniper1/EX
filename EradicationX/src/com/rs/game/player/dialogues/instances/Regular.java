...
public class Regular extends Dialogue {
	

	public void setPerma(boolean bool) {
		player.setPermaRegular(bool);
	}
	private String getString = "RegularInstance";
	public void startControler() {
		player.getControlerManager().startControler("RegularInstance");	
	}
	public Regular() {
	}
	...
	@Override
	public void start() {
		player.instanceDialogue = "Regular";
		player.setOutside(new WorldTile(3255, 1525, 0));
		stage = 1;
	...
	public void run(int interfaceId, int componentId) {
		boolean getPerma = player.isPermaRegular();
		if (stage == 1) {	
			if (componentId == OPTION_1) {
				Magic.sendNormalTeleportSpell(player, 0, 0, new WorldTile(3255, 1525, 0));
