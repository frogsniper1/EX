...
public class Necrolord extends Dialogue {
	

	public void setPerma(boolean bool) {
		player.setPermaNecroLord(bool);
	}
	private String getString = "NecrolordInstance";
	public void startControler() {
		player.getControlerManager().startControler("NecrolordInstance");	
	}
	public Necrolord() {
	}
	...
	@Override
	public void start() {
		player.instanceDialogue = "Necrolord";
		player.setOutside(new WorldTile(2646, 10425, 0));
		stage = 1;
	...
	public void run(int interfaceId, int componentId) {
		boolean getPerma = player.getPermaNecroLord();
		if (stage == 1) {	
			if (componentId == OPTION_1) {
				Magic.sendNormalTeleportSpell(player, 0, 0, new WorldTile(2646, 10425, 0));
