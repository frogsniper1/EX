...
public class Sunfreet extends Dialogue {
	...
	public void setPerma(boolean bool) {
		player.setPermaSunfreet(bool);
	}
	private String getString = "SunfreetInstance";
	public void startControler() {
		player.getControlerManager().startControler("SunfreetInstance");	
	}
	public Sunfreet() {
	}
	...
	public void start() {
		...
		player.setOutside(new WorldTile(2511, 3082, 0));
		stage = 1;
	...
	public void run(int interfaceId, int componentId) {
		boolean getPerma = player.isPermaSunfreet();
		if (stage == 1) {	
			if (componentId == OPTION_1) {
				Magic.sendNormalTeleportSpell(player, 0, 0, new WorldTile(2511, 3082, 0));
