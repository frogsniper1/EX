...
public class Geno extends Dialogue {
	

	public void setPerma(boolean bool) {
		player.setPermaGeno(bool);
	}
	private String getString = "GenoInstance";
	public void startControler() {
		player.getControlerManager().startControler("GenoInstance");	
	}
	public Geno() {
	}
	...
	@Override
	public void start() {
		player.instanceDialogue = "Geno";
		player.setOutside(new WorldTile(3235, 5499, 0));
		stage = 1;
	...
	public void run(int interfaceId, int componentId) {
		...
		if (stage == 1) {	
			if (componentId == OPTION_1) {
				Magic.sendNormalTeleportSpell(player, 0, 0, new WorldTile(3235, 5499, 0));
