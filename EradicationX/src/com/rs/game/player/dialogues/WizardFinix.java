	...
	public void start() {
		...
		sendEntityDialogue(SEND_1_TEXT_CHAT,
				new String[] {
						...
						"Hello. How can I help you?", }, IS_NPC, npc.getId(),
				9843);
		stage = 1;
	}
			...
			case 11:
				sendEntityDialogue(
						...
						new String[] {
								NPCDefinitions.getNPCDefinitions(npc.getId()).name,
								"I'm "
										+ NPCDefinitions.getNPCDefinitions(npc
												.getId()).name
		...
		case 4:
			sendEntityDialogue(
					...
					new String[] {
							...
							"Runespan." }, IS_NPC, npc.getId(), 9843);
			stage = 5;
			break;
		case 5:
			sendEntityDialogue(SEND_1_TEXT_CHAT,
		...
		case 6:
			sendEntityDialogue(
					...
					new String[] {
							...
							"actually!" }, IS_NPC, npc.getId(), 9843);
			stage = 7;
			break;
		case 7:
		...
		case 12:
			sendEntityDialogue(
					...
					new String[] {
							...
							"world around us is important." }, IS_NPC,
					npc.getId(), 9772);
			stage = 13;
			break;
		case 13:
