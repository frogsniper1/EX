...
public abstract class Dialogue {
	...
	public static final short QUESTION = 9827;
	public static final short CONFUSED = 9812;
	public static final short ANNOYED = 9831;
	public static final short HAPPY = 9848;
	public static final short SAD = 9761;
	public static final short SAD2 = 9768;
	public static final short AFRAID = 9773;
	public static final short NEARDEATH = 9780;
	public static final short ANGRY = 9785;
	public static final short DESTRUCTIVE = 9792;
	public static final short SURPRISED = 9827;
	public static final short SECRETIVE = 9838;
	public static final short LAUGH = 9841;
	public static final short NICE = 9844;
	public static final short MOCKING = 9851;
	public static final short REGULAR = 9810;
	public static final short SLEEPING = 9802;
	public static final short TERROR = 9753;
	...
	public boolean sendNPCDialogue(String n, int npcId, int animationId, String... text) {
		return sendEntityDialogue(n, IS_NPC, npcId, animationId, text);
	}	
	...
	public boolean sendEntityDialogue(String t, int type, int entityId, int animationId,
			String... text) {
		String title = "";
		if (type == IS_PLAYER) {
			title = player.getDisplayName();
	...
	public static boolean sendNPCDialogueNoContinue(Player player, int npcId,
		...
		return sendEntityDialogueNoContinue(player, null, IS_NPC, npcId, animationId,
				text);
	}
	
	public static boolean sendNPCDialogueNoContinue(Player player, String name, int npcId,
			int animationId, String... text) {
		return sendEntityDialogueNoContinue(player, name, IS_NPC, npcId, animationId,
				text);
	}	

	public static boolean sendPlayerDialogueNoContinue(Player player,
			int animationId, String... text) {
		return sendEntityDialogueNoContinue(player, null, IS_PLAYER, -1, animationId,
				text);
	}
	 ...
	 * auto selects title, new dialogues
	 */
	public static boolean sendEntityDialogueNoContinue(Player player, String t, int type,
