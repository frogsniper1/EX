...
public final class LevelUp extends Dialogue {
	...
	public void start() {
		...
		String name = Skills.SKILLS[skill];
	...
	public static void sendNews(Player player, int skill, int level) {
		...
		if(!reachedAll) {
			World.sendWorldMessage("<img=6><col=ff8c38>News: "+player.getDisplayName()+" has achieved "+level+" "+Skills.SKILLS[skill]+".", false);
			return;
		}
	...
	public static void send200m(Player player, int skill) {
		World.sendWorldMessage(
				"<img=6><col=ff8c38>News: " + player.getDisplayName()
						+ " has achieved " + "200m experience in" + " "
	...
	public static void send300m(Player player, int skill) {
		World.sendWorldMessage(
				"<img=6><col=ff8c38>News: " + player.getDisplayName()
						+ " has achieved " + "400m experience in" + " "
						+ Skills.SKILL_NAME[skill] + ".", false);
		return;
	}	
