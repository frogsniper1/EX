...
public class Kuradal extends Dialogue {
	...
	public void start() {
		if (!player.isTalkedWithKuradal()) {
			...
			sendEntityDialogue(IS_NPC, "Kuradal", 9085, 9827,
					"You're back warrior, what do you want now?");
		}
	}
	...
	public void run(int interfaceId, int componentId) {
		...
		case 0:
			...
			sendEntityDialogue(
					...
					9085,
					9827,
					"Im the slayer master of "+Settings.SERVER_NAME+"! I give out slayer tasks to players around the world of "+Settings.SERVER_NAME+".");
			break;
		case 1:
			stage = 2;
		...
		case 6:
			stage = 7;
			sendPlayerDialogue(9827,
					"Okay no problem i try find them! Maybe there is a guide on "+Settings.SERVER_NAME+" forums.");
			break;
		...
		case 20:
			sendEntityDialogue(
					...
					9085,
					9827,
					"Im the only Slayermaster in "+Settings.SERVER_NAME+" and i think 500k is a good price but okay.");
			stage = 7;
			break;
		case 21:
			sendEntityDialogue(IS_NPC, "Kuradal", 9085, 9827, "Okay your task is to kill....");
			stage = 22;
			break;
		case 22:
			sendEntityDialogue(IS_NPC, "Kuradal", 9085, 9827,
		...
		case 23:
			sendPlayerDialogue(9827,
					"Sorry Kuradal, I'll remember my task.");
			stage = 7;
			break;
		}
	}
