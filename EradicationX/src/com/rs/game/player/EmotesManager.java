	...
	public static int getId(int slotId, int packetId) {
		...
		case 2:
			if(packetId == WorldPacketsDecoder.ACTION_BUTTON1_PACKET)
				...
				return -1; //This emote has not been added yet new bow emote
		case 3:	return 5;
		case 4: return 6;
		case 5: return 7;
		case 6: return 8;
		...
		if (!unlockedEmotes.contains(id) && player.getRights() < 2) {
			if (id == 41)
				...
				player.getDialogueManager().startDialogue("SimpleMessage",
						"You have not yet unlocked this emote.");
		} else {
			...
			if (player.getControlerManager().getControler().toString().toLowerCase().contains("gypsy") ||
					player.getControlerManager().getControler().toString().toLowerCase().contains("cyndrith")||
					player.getControlerManager().getControler().toString().toLowerCase().contains("chapter")) { 
					return;
			}}
			if (id == 2) {//Yes
                ...
                player.setNextAnimation(new Animation(4275));//This emote has not been added yet: Needs correct animation
        } else if (id == 31) {//Stomp
                player.setNextAnimation(new Animation(1745));//This emote has not been added yet: Needs correct animation
        } else if (id == 32) {//Flap
                ...
                // This emote has not been added yet skillCape
        	...
        	player.setNextGraphics(new Graphics(1760)); 
                ...
                player.setNextAnimation(new Animation(12934));
                	...
                	player.getPackets().sendGameMessage("This emote has not been added yet: Kneel.");
                } else if (id == 69) {//Begging
                	player.getPackets().sendGameMessage("This emote has not been added yet: Begging.");
                } else if (id == 70) {//Stir Cauldron
                	player.getPackets().sendGameMessage("This emote has not been added yet: Stir cauldron.");
                } else if (id == 71) {//Palm-fist
                    player.setNextAnimation(new Animation(12931));
                } else if (id == 72) {//Tantrum
                	player.getPackets().sendGameMessage("This emote has not been added yet: Tantrum.");
                } else if (id == 73) {//Dramatic Death
                	player.getPackets().sendGameMessage("This emote has not been added yet: Dramatic death.");
                } else if (id == 74) {//Jump & Yell
                	player.getPackets().sendGameMessage("This emote has not been added yet: Jump & yell.");
                } else if (id == 77) {//Point
                	player.getPackets().sendGameMessage("This emote has not been added yet: Point.");
                } else if (id == 78) {//Punch
                	player.getPackets().sendGameMessage("This emote has not been added yet: Punch.");
                } else if (id == 79) {//Raise Hand
                	player.getPackets().sendGameMessage("This emote has not been added yet: Raise hand.");
                } else if (id == 80) {//Make Speach
                	player.getPackets().sendGameMessage("This emote has not been added yet: Make speach.");
                } else if (id == 81) {//Sword Fight
                	player.getPackets().sendGameMessage("This emote has not been added yet: Sword fight.");
                } else if (id == 82) {//Raise Hand (Sitting)
                	player.getPackets().sendGameMessage("This emote has not been added yet: Raise hand.");
                } else if (id == 83) {//Wave (Sitting)
                	player.getPackets().sendGameMessage("This emote has not been added yet: Wave sitting.");
                } else if (id == 84) {//Cheer (Sitting)
                	player.getPackets().sendGameMessage("This emote has not been added yet: Cheer sitting.");
                } else if (id == 85) {//Throw Tomato (Sitting)
                	player.getPackets().sendGameMessage("This emote has not been added yet: Throw tomato sitting.");
                } else if (id == 86) {//Throw Flowers (Sitting)
                	player.getPackets().sendGameMessage("This emote has not been added yet: Throw Flowers sitting.");
                } else if (id == 87) {//Agree (Sitting)
                	player.getPackets().sendGameMessage("This emote has not been added yet: Agree sitting.");
                } else if (id == 88) {//Point (Sitting)
                	player.getPackets().sendGameMessage("This emote has not been added yet: Point sitting.");
                } else if (id == 89) {//Whistle (Sitting)
                	player.getPackets().sendGameMessage("This emote has not been added yet: Whistle sitting.");
                } else if (id == 90) {//Thumbs-Up (Sitting)
                	player.getPackets().sendGameMessage("This emote has not been added yet: Thumbs up sitting.");
                } else if (id == 91) {//Thumbs-Down (Sitting)
                	player.getPackets().sendGameMessage("This emote has not been added yet: Thumbs down sitting.");
                } else if (id == 92) {//Clap (Sitting)
                	player.getPackets().sendGameMessage("This emote has not been added yet: Clap sitting.");
                	...
                	if (!World.canMoveNPC(player.getPlane(), player.getX(),
     				...
     				WorldTasksManager.schedule(new WorldTask() {
     					...
     					public void run() {
     						...
     						if (emote == 10) {
     							player.setAttackedByDelay(Utils.currentTimeMillis() + 12000);
