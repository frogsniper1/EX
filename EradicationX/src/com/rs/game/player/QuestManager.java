...
public final class QuestManager implements Serializable {
	...
	public static enum Quests {
		PERIL_OF_ICE_MONTAINS, NOMADS_REQUIEM, ELITE_CHAPTER_I, ELITE_CHAPTER_II, ELITE_CHAPTER_III, ELITE_CHAPTER_VI, ELITE_CHAPTER_V
	}
	...
	public void checkCompleted() {
		if (!completedQuests.contains(Quests.PERIL_OF_ICE_MONTAINS)
				&& player.getSkills().hasRequirements(Skills.CONSTRUCTION, 10,
