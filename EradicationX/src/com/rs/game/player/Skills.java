...
public long getTotalXp() {
	...
	public static final double MAXIMUM_EXP = 400000000;
	...
	public void addXp(int skill, double exp) {
		...
		if (player.isEradicator() || player.isLentEradicator())
			...
			exp *= 2.5;			
		else if (player.isExtremeDonator() || player.isLentExtreme())
			exp *= 1.7;
		else if (player.isDonator() || player.isLentDonator())
			exp *= 1.4;
