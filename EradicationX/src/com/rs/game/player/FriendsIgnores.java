...
public class FriendsIgnores implements Serializable {
	...
	public void addIgnore(String username, boolean tillLogout) {
		...
		if (username.equals(player.getUsername()) || username.equals(player.getDisplayName())) {
		...
		Player p2 = World.getPlayerByDisplayName(username);
		String formatedUsername = p2 != null ? p2.getUsername() : Utils
