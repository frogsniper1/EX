...
import com.rs.game.npc.instances.InstanceFatalTrio;
import com.rs.game.npc.instances.InstanceSomethingTrio;
import com.rs.game.npc.instances.InstanceCopyrightTrio;
...
public class TrioInstance extends Controler {
	...
	private int count;
	private WorldTile ORIGINAL_LOCATION =  new WorldTile(3359, 9434, 0);

	public static void enterTrioInstance(Player player) {
		player.getControlerManager().startControler("TrioInstanceControler", 1);
	}

	@Override
	public void start() {
		boundChuncks = RegionBuilder.findEmptyChunkBound(8, 8);
		RegionBuilder.copyAllPlanesMap(418, 1177, boundChuncks[0], boundChuncks[1], 8);	
		instanceover = false;
    ...
    private void startTimer() {
    	WorldTasksManager.schedule(new WorldTask() {
			...
			public void run() {
				...
				if (count == 1) {
					try {
					World.spawnObject(new WorldObject(12351, 10, 1, getWorldTileX(18), getWorldTileY(19),  0), true);
					World.spawnObject(new WorldObject(12351, 10, 0, getWorldTileX(19), getWorldTileY(16),  0), true);
					World.spawnObject(new WorldObject(12351, 10, 0, getWorldTileX(10), getWorldTileY(16),  0), true);
					World.spawnObject(new WorldObject(12351, 10, 1, getWorldTileX(12), getWorldTileY(19),  0), true);
					World.spawnObject(new WorldObject(12351, 10, 1, getWorldTileX(11), getWorldTileY(19),  0), true);
					World.spawnObject(new WorldObject(1, 10, 1, getWorldTileX(10), getWorldTileY(18),  0), true);
					World.spawnObject(new WorldObject(1, 10, 1, getWorldTileX(10), getWorldTileY(17),  0), true);
					World.spawnObject(new WorldObject(1, 10, 1, getWorldTileX(10), getWorldTileY(20),  0), true);
					World.spawnObject(new WorldObject(1, 10, 1, getWorldTileX(10), getWorldTileY(21),  0), true);				
					World.spawnObject(new WorldObject(1, 10, 1, getWorldTileX(10), getWorldTileY(19),  0), true);
					World.spawnObject(new WorldObject(1, 10, 1, getWorldTileX(12), getWorldTileY(25),  0), true);		
					World.spawnObject(new WorldObject(1, 10, 1, getWorldTileX(17), getWorldTileY(25),  0), true);	
					World.spawnObject(new WorldObject(1, 10, 1, getWorldTileX(13), getWorldTileY(19),  0), true);
					World.spawnObject(new WorldObject(1, 10, 1, getWorldTileX(14), getWorldTileY(19),  0), true);
					World.spawnObject(new WorldObject(1, 10, 1, getWorldTileX(15), getWorldTileY(19),  0), true);				
					World.spawnObject(new WorldObject(1, 10, 1, getWorldTileX(16), getWorldTileY(19),  0), true);
					World.spawnObject(new WorldObject(1, 10, 1, getWorldTileX(17), getWorldTileY(19),  0), true);
					World.spawnObject(new WorldObject(1, 10, 1, getWorldTileX(19), getWorldTileY(19),  0), true);
					World.spawnObject(new WorldObject(1, 10, 1, getWorldTileX(19), getWorldTileY(18),  0), true);
					World.spawnObject(new WorldObject(1, 10, 1, getWorldTileX(19), getWorldTileY(17),  0), true);
					World.spawnObject(new WorldObject(1, 10, 1, getWorldTileX(19), getWorldTileY(20),  0), true);
					World.spawnObject(new WorldObject(1, 10, 1, getWorldTileX(19), getWorldTileY(21),  0), true);
	...
	public void startWave() {
		try {
		new InstanceFatalTrio(15003, getSpawnTile(0));
		new InstanceSomethingTrio(15002, getSpawnTile(1));
		new InstanceCopyrightTrio(1900, getSpawnTile(2));
		} catch (Throwable t) {
			Logger.handle(t);
		}
	}
