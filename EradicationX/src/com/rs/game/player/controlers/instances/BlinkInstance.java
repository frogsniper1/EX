...
public class BlinkInstance extends Controler {
	...
	public static void enterTrioInstance(Player player) {
		player.getControlerManager().startControler("BlinkInstanceControler", 1);
	}
    ...
    private void startTimer() {
    	WorldTasksManager.schedule(new WorldTask() {
			...
			public void run() {
				...
				if (count == 1) {
					try {
					World.spawnObject(new WorldObject(28779, 10, 1, getWorldTileX(16), getWorldTileY(21), 0), true);
					} catch (Throwable t) {
						Logger.handle(t);
					}
				}
