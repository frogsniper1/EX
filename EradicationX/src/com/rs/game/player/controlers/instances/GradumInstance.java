...
import com.rs.game.npc.instances.InstanceGradum;
...
public class GradumInstance extends Controler {
	...
	private WorldTile ORIGINAL_LOCATION =  new WorldTile(2901, 4397, 0);

	public static void enterTrioInstance(Player player) {
		player.getControlerManager().startControler("GradumInstanceControler", 1);
	}
	...
	public void startWave() {
		try {
		new InstanceGradum(14260, getSpawnTile(0));
		} catch (Throwable t) {
			Logger.handle(t);
		}
	}
