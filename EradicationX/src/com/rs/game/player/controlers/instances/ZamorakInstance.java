...
import com.rs.game.npc.instances.InstanceZamorak;
...
public class ZamorakInstance extends Controler {
	...
	public static void enterTrioInstance(Player player) {
		player.getControlerManager().startControler("ZamorakInstanceControler", 1);
	}
