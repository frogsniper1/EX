...
import com.rs.game.npc.instances.InstanceEradicator;
...
public class EradicatorInstance extends Controler {
	...
	private int count;
	private WorldTile ORIGINAL_LOCATION =  new WorldTile(2944, 4389, 0);
	...
	public void start() {
		...
		RegionBuilder.copyAllPlanesMap(365, 546, boundChuncks[0], boundChuncks[1], 8);	
	...
	public void startWave() {
		try {
		new InstanceEradicator(11872, getSpawnTile(0));
		} catch (Throwable t) {
			Logger.handle(t);
		}
	}
