...
import com.rs.game.npc.instances.InstanceRajj;
...
public class RajjInstance extends Controler {
	...
	private int count;
	private WorldTile ORIGINAL_LOCATION =  new WorldTile(4991, 4195, 3);

	public static void enterTrioInstance(Player player) {
		player.getControlerManager().startControler("RajjInstanceControler", 1);
	}
	...
	public void startWave() {
		try {
		new InstanceRajj(15009, getSpawnTile(0));
		} catch (Throwable t) {
			Logger.handle(t);
		}
	}
