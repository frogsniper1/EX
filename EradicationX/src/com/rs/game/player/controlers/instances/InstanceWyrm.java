...
import com.rs.game.npc.instances.InstanceWildywyrm;
...
public class InstanceWyrm extends Controler {
	...
	private WorldTile ORIGINAL_LOCATION =  new WorldTile(3968, 4823, 1);

	public static void enterTrioInstance(Player player) {
		player.getControlerManager().startControler("BandosInstanceControler", 1);
	}
	...
	public void startWave() {
		try {
		new InstanceWildywyrm(3334, getSpawnTile(0));
		} catch (Throwable t) {
			Logger.handle(t);
		}
	}
