...
import com.rs.game.npc.instances.InstanceSupers;
...
public class SupersInstance extends Controler {
	...
	private int count;
	private WorldTile ORIGINAL_LOCATION =  new WorldTile(2344, 5608, 0);
	...
	public void startWave() {
		try {
		new InstanceSupers(14413, getSpawnTile(0));
		new InstanceSupers(14413, getSpawnTile(1));
		new InstanceSupers(14413, getSpawnTile(2));
		new InstanceSupers(14413, getSpawnTile(3));
		new InstanceSupers(14413, getSpawnTile(4));
		new InstanceSupers(14413, getSpawnTile(5));
		new InstanceSupers(14413, getSpawnTile(6));
		new InstanceSupers(14413, getSpawnTile(7));
		} catch (Throwable t) {
			Logger.handle(t);
		}
	}
