...
import com.rs.game.npc.instances.InstanceArmadyl;
...
public class ArmadylInstance extends Controler {
	...
	public static void enterTrioInstance(Player player) {
		player.getControlerManager().startControler("ArmadylInstanceControler", 1);
	}
