...
import com.rs.game.npc.instances.InstanceSaradomin;
...
public class SaradominInstance extends Controler {
	...
	public static void enterTrioInstance(Player player) {
		player.getControlerManager().startControler("SaradominInstanceControler", 1);
	}
