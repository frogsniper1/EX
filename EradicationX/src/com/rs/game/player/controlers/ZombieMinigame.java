...
import com.rs.game.npc.zombies.SkeletalHorror;
...
public class ZombieMinigame extends Controler {

	public static final WorldTile OUTSIDE = new WorldTile(3244, 3195, 0);
			...
			public void run() {
				...
				WorldTasksManager.schedule(new WorldTask()  {
					...
					public void run() {
						...
						player.getDialogueManager().startDialogue("SimpleNPCMessage", ZOMBIE_MONK, "Goodluck on this mission mate! <br>Take out asmany zombies as you can!");
		...
		if(type == 0 || type == 2)
			...
			if(type == 1 || type == 4) {
				...
				if(type == 4) {
					...
					player.reset();
					player.getDialogueManager().startDialogue("SimpleNPCMessage", ZOMBIE_MONK, "You defeat every wave! Take this as a reward!.");
					player.getPackets().sendGameMessage("You were victorious!");
					if(!player.getInventory().addItem(6571, 1)) {
						World.addGroundItem(new Item(6571, 1), new WorldTile(player), player, null, true, 180,true);
						World.addGroundItem(new Item(6529, 16064), new WorldTile(player), player, null, true, 180,true);
					...
					if(!player.getInventory().addItem(6529, tokkul)) 
						World.addGroundItem(new Item(6529, tokkul), new WorldTile(player), player, null, true, 180,true);
					player.getDialogueManager().startDialogue("SimpleNPCMessage", ZOMBIE_MONK, "Well done in the cave, here, take TokKul as reward.");
					//TODO tokens
				}
			}
			removeControler();
