...
import com.rs.game.player.controlers.instances.TrioInstance;
import com.rs.game.player.controlers.instances.*;
...
public class ControlerHandler {
	...
	public static final void init() {
		try {
			...
			handledControlers.put("DummyControler", (Class<Controler>) Class.forName(DummyControler.class.getCanonicalName()));
			...
			handledControlers.put("LegendsMinigame", (Class<Controler>) Class.forName(LegendsMinigame.class.getCanonicalName()));
			handledControlers.put("HairymonkeyInstance", (Class<Controler>) Class.forName(HairymonkeyInstance.class.getCanonicalName()));
			handledControlers.put("SharedInstance", (Class<Controler>) Class.forName(SharedInstance.class.getCanonicalName()));	
			handledControlers.put("SupersInstance", (Class<Controler>) Class.forName(SupersInstance.class.getCanonicalName()));
			handledControlers.put("TrioInstance", (Class<Controler>) Class.forName(TrioInstance.class.getCanonicalName()));
			handledControlers.put("ArmadylInstance", (Class<Controler>) Class.forName(ArmadylInstance.class.getCanonicalName()));
			handledControlers.put("BandosInstance", (Class<Controler>) Class.forName(BandosInstance.class.getCanonicalName()));
			handledControlers.put("BlinkInstance", (Class<Controler>) Class.forName(BlinkInstance.class.getCanonicalName()));
			handledControlers.put("BrutalsInstance", (Class<Controler>) Class.forName(BrutalsInstance.class.getCanonicalName()));
			handledControlers.put("CorpInstance", (Class<Controler>) Class.forName(CorpInstance.class.getCanonicalName()));
			handledControlers.put("EradicatorInstance", (Class<Controler>) Class.forName(EradicatorInstance.class.getCanonicalName()));
			handledControlers.put("EradJadInstance", (Class<Controler>) Class.forName(EradJadInstance.class.getCanonicalName()));
			handledControlers.put("EradKingInstance", (Class<Controler>) Class.forName(EradKingInstance.class.getCanonicalName()));
			handledControlers.put("FearInstance", (Class<Controler>) Class.forName(FearInstance.class.getCanonicalName()));
			handledControlers.put("GenoInstance", (Class<Controler>) Class.forName(GenoInstance.class.getCanonicalName()));
			handledControlers.put("GradumInstance", (Class<Controler>) Class.forName(GradumInstance.class.getCanonicalName()));
			handledControlers.put("InstanceWyrm", (Class<Controler>) Class.forName(InstanceWyrm.class.getCanonicalName()));
			handledControlers.put("NecrolordInstance", (Class<Controler>) Class.forName(NecrolordInstance.class.getCanonicalName()));
			handledControlers.put("RajjInstance", (Class<Controler>) Class.forName(RajjInstance.class.getCanonicalName()));
			handledControlers.put("RegularInstance", (Class<Controler>) Class.forName(RegularInstance.class.getCanonicalName()));
			handledControlers.put("SaradominInstance", (Class<Controler>) Class.forName(SaradominInstance.class.getCanonicalName()));
			handledControlers.put("STQInstance", (Class<Controler>) Class.forName(STQInstance.class.getCanonicalName()));
			handledControlers.put("ZamorakInstance", (Class<Controler>) Class.forName(ZamorakInstance.class.getCanonicalName()));
			handledControlers.put("SunfreetInstance", (Class<Controler>) Class.forName(SunfreetInstance.class.getCanonicalName()));
			handledControlers.put("HardModeTrioInstance", (Class<Controler>) Class.forName(HardModeTrioInstance.class.getCanonicalName()));
			handledControlers.put("ExtremeInstance", (Class<Controler>) Class.forName(ExtremeInstance.class.getCanonicalName()));	
			handledControlers.put("AnniversaryEventControler", (Class<Controler>) Class.forName(AnniversaryEventControler.class.getCanonicalName()));	
			handledControlers.put("SharedInstanceHardMode", (Class<Controler>) Class.forName(SharedInstanceHardMode.class.getCanonicalName()));	
			handledControlers.put("GypsyScene", (Class<Controler>) Class.forName(GypsyScene.class.getCanonicalName()));	
			handledControlers.put("CyndrithChapterIICutscene", (Class<Controler>) Class.forName(CyndrithChapterIICutscene.class.getCanonicalName()));	
			handledControlers.put("CyndrithChapterIISkeletonBurial", (Class<Controler>) Class.forName(CyndrithChapterIISkeletonBurial.class.getCanonicalName()));
			handledControlers.put("CyndrithChapterIIDragithFinal", (Class<Controler>) Class.forName(CyndrithChapterIIDragithFinal.class.getCanonicalName()));	
			handledControlers.put("CyndrithChapterIICutscene2", (Class<Controler>) Class.forName(CyndrithChapterIICutscene2.class.getCanonicalName()));	
		} catch (Throwable e) {
			Logger.handle(e);
		}
	}
