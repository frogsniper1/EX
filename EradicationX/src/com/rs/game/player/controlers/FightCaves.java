				...
				if (type == 4) {
					...
					if (!player.getInventory().addItem(6570, 1) && player.getInventory().addItem(23659, 1)) {
						World.addGroundItem(new Item(6570, 1), new WorldTile(
								...
								player), player, null, true, 180, true);
						World.addGroundItem(new Item(23651, 16064),
								new WorldTile(player), null, player, true, 180, true);
					} else if (!player.getInventory().addItem(23651, 16064))
						World.addGroundItem(new Item(23651, 16064),
					...
					if (!player.getInventory().addItem(23651, tokkul))
						World.addGroundItem(new Item(23651, tokkul),
								new WorldTile(player), player, null, true, 180, true);
					player.getDialogueManager()
							.startDialogue("SimpleNPCMessage", THHAAR_MEJ_JAL,
