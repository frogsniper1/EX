...
public class Clan implements Serializable {
	...
	private String clanTitleShade;
	private String clanTitleColor;
	private String clanTitleNameColor;
	...
	public String getWholeTitle() {
		return "<shad=" + getTitleShade() + ">" +"<col="+ getTitleColor() +">" + getTitle() + " </col><col=" + getTitleNameColor() + ">";
	}

	public void setTitleNameColor(String namecolor) {
		clanTitleNameColor = namecolor;
	}
	
	public void setTitleColor(String titlecolor) {
		clanTitleColor = titlecolor;
	}

	public void setTitleShade(String titleshade) {
		clanTitleShade = titleshade;
	}
	
	public String getTitleNameColor() {
		if (clanTitleNameColor == null)
			clanTitleNameColor = "ffffff";
		return clanTitleNameColor;			
	}	
	
	public String getTitleColor() {
		if (clanTitleColor == null)
			clanTitleColor = "ffffff";
		return clanTitleColor;			
	}
	
	public String getTitleShade() {
		if (clanTitleShade == null)
			clanTitleShade = "";
		return clanTitleShade;	
	}
