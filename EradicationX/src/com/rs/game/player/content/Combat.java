		...
		if (target instanceof NPC) {
			...
			if (shieldName != null) {
				if (shieldName.contains("shield"))
					return 1156;
				if (shieldName.contains("defender") || shieldName.contains("Off-hand") || shieldName.contains("off hand")|| shieldName.contains("offhand")|| shieldName.contains("off-hand")
						|| shieldName.contains("Off-hand ")
						|| shieldName.contains("Off-Hand"))
					return 4177;
			}
			switch (shieldId) {
