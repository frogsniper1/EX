package com.rs.game.player.content.ranking;
...
public class DonationRank  implements Serializable {
	...
	private static final String PATH = "data/donation.rank";

	public DonationRank(Player player) {
		this.username = player.getUsername();
		this.amountDonated = player.donatedtotal;
	...
	public static void showRanks(Player player) {
		...
		for (DonationRank rank : ranks) {
			...
			player.getPackets().sendIComponentText(
					1158,
					10 + count * 5,
					"Total level: "+Utils.getFormattedNumber(rank.totalLevel));
	...
	public static void checkRank(Player player) {
		...
		//	return;
		//}
		int amountDonated = player.donatedtotal;
