...
public final class Pet extends NPC {
	...
	public void processNPC() {
		...
		if (id == 15981 || id == 15982 || id == 15983) {
		count+=2;
		if (count >= 100) {
			count = 0;
			setNextAnimation(new Animation(13190));
			transformIntoNPC(id == 15981 ? 15982 : id == 15982 ? 15983 : 15981);
		}
		}
		if (growthRate > 0.000) {
...
/**
	...
	protected void sendFollow() {
		if (id == 15980) {
			setNextWorldTile(new WorldTile(owner.getX(), owner.getY()-1, owner.getPlane()));
			return;
		}
