...
public class SponsorbossCombat extends CombatScript {
	...
	public int attack(final NPC npc, Entity target) {
		...
		if (attackStyle == 0) {
			...
			World.sendGraphics(npc, new Graphics(2867), center);
			...
			delayHit(
					...
					getMagicHit(
							npc,
							getRandomMaxHit(npc, Utils.random(190),
			...
			npc.setNextGraphics(new Graphics(2881));
			npc.heal(100);
		}
		return 5;
	}
