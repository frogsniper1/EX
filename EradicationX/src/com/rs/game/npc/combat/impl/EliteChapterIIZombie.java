...
public class EliteChapterIIZombie extends CombatScript {

	public static final String[] ATTACKS = new String[] {
		"Aaaaaaaaaaaaaaaaaaaaaaa......",
			"I used to be an adventurer like you, but now I'm a zombie" ,"Blueeeeeeeehhhhhhhhh", "Uuuuuuuuuuu", "Raaaaaaaaa!"};

	@Override
	public Object[] getKeys() {
		return new Object[] { 15975 };
	}
	
	private Hit isBig(NPC npc) {
		int num = Utils.getRandom(2);
		if (num == 2)
			return new Hit(npc, Utils.random(100), HitLook.DESEASE_DAMAGE);
		if (num == 1)
			return new Hit(npc, Utils.random(100), HitLook.REGULAR_DAMAGE);
