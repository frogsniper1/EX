...
public class Crucible {
	...
	public static void removePlayer(Player player,
			CrucibleControler crucibleControler, boolean logout) {
		synchronized (LOCK) {
			if (!logout) {
			...
			if (crucibleControler.getTarget() != null) {
				CrucibleControler targetControler = getControler(crucibleControler
						.getTarget());
	...
	public static void addPlayer(Player player,
			CrucibleControler crucibleControler) {
		synchronized (LOCK) {
	...
	public static boolean addTarget(Player player, Player target,
			CrucibleControler playerControler) {
	...
	public static CrucibleControler getControler(Player player) {
		...
		return (CrucibleControler) (controler instanceof CrucibleControler ? controler
				: null);
	}
