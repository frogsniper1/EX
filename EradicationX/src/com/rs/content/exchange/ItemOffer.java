...
public class ItemOffer extends Item {
	...
	private static final long serialVersionUID = -4714994975363443197L;
	...
	public ItemOffer(Player player, int itemId, OfferType type, int slot) {
		...
		this.price = (this.getDefinitions().getValue() == -1 ? this.getDefinitions().getValue() : this.getDefinitions().getValue());
