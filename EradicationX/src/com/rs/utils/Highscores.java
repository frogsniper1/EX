...
public class Highscores implements Runnable {
	...
	public void run() {
		try {
			Database db = new Database("23.229.239.38", "luka_vote", "WBService92", "vote_new_luka");
			...
			PreparedStatement stmt1 = db.prepare("DELETE FROM Highscores WHERE username=?");
